...
```{r density-4C, eval = FALSE}
psych_df %>% 
  ggplot(aes(x = stress_score, color = diagnosis)) +
  geom_density(alpha = 0.5) +
  scale_color_manual(values = c("gray", "lightyellow", "lightblue")) +
  theme_bw()
```
...
```{r density-4C, echo = FALSE, fig.align="center", fig.height = 5.5}
```

::: notes

Same thing for overriding color scale.
