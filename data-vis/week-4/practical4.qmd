...
-   App engagement data: [app_engagement.csv](../data/app_engagement.csv)
...
```{r}
#| include: false
app_df <- read_csv(here("data-vis",  "data", "app_engagement.csv"))
```
...
```{r}
app_df <- app_df %>%
  mutate(user_segment = factor(user_segment, levels = c("Students", "EarlyCareer","MidCareer", "Senior")))
```
